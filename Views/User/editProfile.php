                ...
                <div class="row">
                    <div class="col mb-3">
                        <div class="card">
                            <div class="card-body">
                                <div class="e-profile">
                                    <form class="form" method="post" action="../../Controllers/EditProfileController.php" enctype="multipart/form-data">
                                        
                                        <input type="text" name="id" value="<?=$myuser['id'] ?>" hidden>
                                        <div class="row">
                                                ...
                                                <div class="text-center text-sm-left mb-2 mb-sm-0">
                                                    ...
                                                    <div class="mt-2">
                                                        ...
                                                        <button class="btn btn-warning" type="button">
                                                            ...
                                                            <input style="height: 50%; width: 50%;" accept="image/*" class="custom-file-input required" type='file' id="imgInp" aria-describedby="input requiredGroupFileAddon01" name="image">
                                                        </button>
                                                    </div>
                                                </div>
                    ...
                    <div class="col-12 col-md-3 mb-3">
                        <div class="card mb-3">
                            <div class="card-body">
                                <div class="px-xl-3">
                                    <a href="../../Controllers/Authentification/LogoutController.php" class="btn btn-block btn-secondary">
