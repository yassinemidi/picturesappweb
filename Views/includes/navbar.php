    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="<?= $abs_path ?>/Views/User/editProfile.php?id=<?=$_SESSION['user_id'] ?>"><i class="fa fa-user" aria-hidden="true"></i> Edit Profile</a>
      ...
      <li class="nav-item dropdown">
        ...
        ?>
          <a class="dropdown-item" href="<?=$abs_path ?>/Views/User/showProfile.php?id=<?=$us['id'] ?>">
            <img src="../../uploads/<?=$us['image'] ?>" class="rounded-circle" alt="Cinque Terre" width="30px" height="30px">
      ...
      <li class="nav-item">
        <a href="<?=$abs_path ?>/Views/LiveSearch.php" class="nav-link" ><i class="fa fa-search" aria-hidden="true"></i> Sreach</a>
      </li>
